...
const users = [
    { username: "laura quimbaya", email: "cami@gmail.com", password: "Chafa3112%" },
    { usernam: "sebas amaya", email: "sebas@gmail.com", password: "Chafa3112%" },
    { username: "eren jaeger", email: "eren@gmail.com", password: "Chafa3112%" }
]
...
const genres = [
    ...
    { name: "Animado", image: "https://www.industriaanimacion.com/wp-content/uploads/2020/12/Cover-8-Partes-1.jpg" },
]
...
sequelize.sync({ force: true }).then(() => {
    ...
    movies[0].addCharacter(characters[0])
    movies[0].addCharacter(characters[1])
    movies[1].addCharacter(characters[2])
    movies[1].addCharacter(characters[3])
    movies[2].addCharacter(characters[4])
    movies[2].addCharacter(characters[5])
    movies[3].addCharacter(characters[6])
    movies[3].addCharacter(characters[7])

    // genres[0].addMovie(movies[0])
    // genres[1].addMovie(movies[0])
    // genres[1].addMovie(movies[3])
    // genres[1].addMovie(movies[1])
    // genres[2].addMovie(movies[2])
    // genres[3].addMovie(movies[3])
    // genres[3].addMovie(movies[1])
})